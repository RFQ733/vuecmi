<template>
  ...
  <el-row :gutter="24" class="enhanced-row">
    <!-- 左侧图表区块 -->
    <el-col :xs="24" :sm="24" :md="10" :lg="9" :xl="10" class="chart-column">
    ...
    <!-- 右侧预测信息区块 -->
    <el-col :xs="24" :sm="24" :md="24" :lg="5" :xl="8" class="prediction-column">
...
export default {
  ...
  data() {
    return {
      ...
      FormData: {
        selectedRNA: "this.miRNA.miRNA_id",
